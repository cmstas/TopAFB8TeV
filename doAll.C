void doAll(TString outputDir="results", bool rundata=true, bool runsig=false, bool runmc = true, bool requireBTag=true, bool require2BTag=false, bool usePF = true, 
	   ...
	   bool scaleJESMETDown = false, bool sendOutputToLogFile = true, bool BTagAlgTCHE = false, bool createBabyNtuples = false, bool doBFR = false)
{
  ...
  */
  ...
  float lumiToNormalizeTo   = 19300.0e-3; //4980.0e-3; //4684.0e-3; //3230.0e-3; //1090.0e-3; //349.0e-3; //204.0e-3;// 191.0e-3 ; //36.1e-3; 
  ...
  string cms2_skim_location="/nfs-7/userdata/yanjuntu/SkimTprime2012_v1";   //copied from tprime doAll
  string cms2_location="/nfs-6/userdata/cms2";
  ...
  // v_baseCuts.push_back("applyLeptonPtWeighting");    //This hasn't been added to topAFB_looper.C yet
  // v_baseCuts.push_back("applyJetPtWeighting");       //This hasn't been added to topAFB_looper.C yet
  //
  ...
  if(rundata) {
    ...
    if(runskim){
        ...
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/DoubleElectron_Run2012A-recover-06Aug2012-v1_AOD/merged/merged*root",cms2_skim_location.data()));
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/DoubleMu_Run2012A-recover-06Aug2012-v1_AOD/merged/merged*root",cms2_skim_location.data()));
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/MuEG_Run2012A-recover-06Aug2012-v1_AOD/merged/merged*root",cms2_skim_location.data()));

        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/DoubleElectron_Run2012A-13Jul2012-v1_AOD/merged/merged*root",cms2_skim_location.data()));
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/DoubleMu_Run2012A-13Jul2012-v1_AOD/merged/merged*root",cms2_skim_location.data()));
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/MuEG_Run2012A-13Jul2012-v1_AOD/merged/merged*root",cms2_skim_location.data()));

        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/DoubleElectron_Run2012B-13Jul2012-v1_AOD/merged/merged*root",cms2_skim_location.data()));
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/DoubleMu_Run2012B-13Jul2012-v4_AOD/merged/merged*root",cms2_skim_location.data()));
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/MuEG_Run2012B-13Jul2012-v1_AOD/merged/merged*root",cms2_skim_location.data()));

        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/DoubleElectron_Run2012C-24Aug2012-v1_AOD/merged/merged*root",cms2_skim_location.data()));
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/DoubleMu_Run2012C-24Aug2012-v1_AOD/merged/merged*root",cms2_skim_location.data()));
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/MuEG_Run2012C-24Aug2012-v1_AOD/merged/merged*root",cms2_skim_location.data()));

        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/DoubleElectron_Run2012C-PromptReco-v2_AOD/merged/merged*root",cms2_skim_location.data()));
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/DoubleMu_Run2012C-PromptReco-v2_AOD/merged/merged*root",cms2_skim_location.data()));
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/MuEG_Run2012C-PromptReco-v2_AOD/merged/merged*root",cms2_skim_location.data()));

        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/DoubleElectron_Run2012D-PromptReco-v1_AOD/merged/merged*root",cms2_skim_location.data()));
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/DoubleMu_Run2012D-PromptReco-v1_AOD/merged/merged*root",cms2_skim_location.data()));
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/MuEG_Run2012D-PromptReco-v1_AOD/merged/merged*root",cms2_skim_location.data()));

    }
    else{
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/DoubleElectron_Run2012A-recover-06Aug2012-v1_AOD/merged/merged*root",cms2_location.data()));
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/DoubleMu_Run2012A-recover-06Aug2012-v1_AOD/merged/merged*root",cms2_location.data()));
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/MuEG_Run2012A-recover-06Aug2012-v1_AOD/merged/merged*root",cms2_location.data()));

        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/DoubleElectron_Run2012A-13Jul2012-v1_AOD/merged/merged*root",cms2_location.data()));
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/DoubleMu_Run2012A-13Jul2012-v1_AOD/merged/merged*root",cms2_location.data()));
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/MuEG_Run2012A-13Jul2012-v1_AOD/merged/merged*root",cms2_location.data()));

        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/DoubleElectron_Run2012B-13Jul2012-v1_AOD/merged/merged*root",cms2_location.data()));
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/DoubleMu_Run2012B-13Jul2012-v4_AOD/merged/merged*root",cms2_location.data()));
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/MuEG_Run2012B-13Jul2012-v1_AOD/merged/merged*root",cms2_location.data()));

        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/DoubleElectron_Run2012C-24Aug2012-v1_AOD/merged/merged*root",cms2_location.data()));
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/DoubleMu_Run2012C-24Aug2012-v1_AOD/merged/merged*root",cms2_location.data()));
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/MuEG_Run2012C-24Aug2012-v1_AOD/merged/merged*root",cms2_location.data()));

        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/DoubleElectron_Run2012C-PromptReco-v2_AOD/merged/merged*root",cms2_location.data()));
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/DoubleMu_Run2012C-PromptReco-v2_AOD/merged/merged*root",cms2_location.data()));
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/MuEG_Run2012C-PromptReco-v2_AOD/merged/merged*root",cms2_location.data()));

        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/DoubleElectron_Run2012D-PromptReco-v1_AOD/merged/merged*root",cms2_location.data()));
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/DoubleMu_Run2012D-PromptReco-v1_AOD/merged/merged*root",cms2_location.data()));
        ch_data->Add(Form("%s/Data2012/CMSSW_5_3_2_patch4_V05-03-24/MuEG_Run2012D-PromptReco-v1_AOD/merged/merged*root",cms2_location.data()));
...
if(runttdil) {
	...
	cout << "Doing the MadGraph ttbar sample..." << endl;
    if(runskim) {
      // cout << "Doing the MadGraph ttbar sample" << endl;
	  //ch_ttbar->Add(Form("%s/%s", cms2_skim_location.c_str(),"TTJets_TuneZ2_7TeV-madgraph-tauola_Summer11-PU_S4_START42_V11-v1/V04-02-29/skimmed*root"));
      //cout << "Doing the powheg ttbar sample" << endl;
	  //ch_ttbar->Add(Form("%s/%s", cms2_skim_location.c_str(),"TTTo2L2Nu2B_7TeV-powheg-pythia6_Summer11-PU_S4_START42_V11-v1/V04-02-29/skimmed*root"));
      //cout << "Doing the powheg tauola ttbar sample" << endl;
	  //ch_ttbar->Add("/hadoop/cms/store/group/snt/papers2011/Summer11MC/TT_TuneZ2_7TeV-powheg-tauola_Summer11-PU_S4_START42_V11-v1/V04-02-29/merged*root");
      //cout << "Doing the Fall11 MC@NLO ttbar sample" << endl;
	  //ch_ttbar->Add(Form("%s/%s", cms2_skim_location.c_str(),"TT_TuneZ2_7TeV-mcatnlo_Fall11-PU_S6_START42_V14B-v1/V04-02-29_fix_dilepton/skimmed*root"));

        ch_ttbar->Add(Form("%s/Summer12_53X_MC/TTJets_FullLeptMGDecays_8TeV-madgraph_Summer12_DR53X-PU_S10_START53_V7A-v2/V05-03-24/merged*root",cms2_skim_location.data()));
    } 
    else{
      //cout << "Doing the MadGraph ttbar sample" << endl;
	  //ch_ttbar->Add("/nfs-7/userdata/cms2/TTJets_TuneZ2_7TeV-madgraph-tauola_Summer11-PU_S4_START42_V11-v1/V04-02-29/merged*root");
      //cout << "Doing the powheg ttbar sample" << endl;
	  //ch_ttbar->Add("/nfs-7/userdata/cms2/TTTo2L2Nu2B_7TeV-powheg-pythia6_Summer11-PU_S4_START42_V11-v1/V04-02-29/merged*root");
      //cout << "Doing the powheg tauola ttbar sample" << endl;
	  //ch_ttbar->Add("/hadoop/cms/store/group/snt/papers2011/Summer11MC/TT_TuneZ2_7TeV-powheg-tauola_Summer11-PU_S4_START42_V11-v1/V04-02-29/merged*root");
      //cout << "Doing the Fall11 MC@NLO ttbar sample" << endl;
	  //ch_ttbar->Add("/nfs-7/userdata/cms2/TT_TuneZ2_7TeV-mcatnlo_Fall11-PU_S6_START42_V14B-v1/V04-02-29_fix_dilepton/merged*root");

        ch_ttbar->Add(Form("%s/Summer12_53X_MC/TTJets_FullLeptMGDecays_8TeV-madgraph_Summer12_DR53X-PU_S10_START53_V7A-v2/V05-03-24/merged*root",cms2_location.data()));
    }
    ...
    //for mc@NLO
    baby->ScanChain(ch_ttbar, v_Cuts, "ttdil",doFRestimation, lumiToNormalizeTo, kttdil, false); //must mutliply by ratio of per-event xsec and PREP xsec to account for negative weights
	// lumiToNormalizeTo*(154./157.5)*(190.41256/147.4)
 ...
 if(runttdilsys) {
   ...
   cout << "Doing the scale down mc@nlo ttbar sys sample" << endl;
   ch_ttbar->Add("/nfs-7/userdata/cms2/FastSim_mcatnlo-private-SC-fac-0.5-ren-0.5_LHE2EDM_v1_RWTH_0614_fhohle-TT_mcatnlo_private_fac-0.5-ren-0.5_withSC_FastSim_coherent_Summer11FullSim_FastSimJetFixTest_AOD_0616-98893edf89c918d9b6d63453d739e0c0/VB04-02-29_Fastsim/merged*root");
 ...
 if(runSMS) {
   ...
   if(runskim){
     //ch_sms->Add(Form("%s/%s", cms2_skim_location.c_str(),"SMS-T2tt_Mstop-225to1200_mLSP-50to1025_7TeV-Pythia6Z_Summer11-PU_START42_V11_FastSim-v1/skimmed*.root"));
        ch_sms->Add(Form("%s/Summer12_53X_MC/SMS-T2tt_Mstop-225to1200_mLSP-50to1025_7TeV-Pythia6Z_Summer11-PU_START42_V11_FastSim-v1/skimmed*.root",cms2_skim_location.data()));
   }
   else{
     ...
     //ch_sms->Add("/hadoop/cms/store/group/snt/papers2011/Summer11MC/SMS-T2tt_Mstop-225to1200_mLSP-50to1025_7TeV-Pythia6Z_Summer11-PU_START42_V11_FastSim-v1/V04-02-20-04/merged*.root");
        ch_sms->Add(Form("%s/Summer12_53X_MC/SMS-T2blnu_x-0p25to0p75_mStop-50to850_mLSP-50to800_7TeV-Pythia6Z_Summer11-PU_START42_V11_FSIM-v2/VB04-02-29_Fastsim/merged*root",cms2_location.data()));
   }
  ...
  if(runttotr) {
	...
	cout << "Doing the Summer '12 MadGraph ttbar no-dileptons..." << endl;
    if(runskim){
      //cout << "Doing the Fall11 MC@NLO ttbar no-dileptons" << endl; ch_ttor->Add(Form("%s/%s", cms2_skim_location.c_str(),"TT_TuneZ2_7TeV-mcatnlo_Fall11-PU_S6_START42_V14B-v1/V04-02-29_fix_dilepton/skimmed*root"));
        ch_ttor->Add(Form("%s/Summer12_53X_MC/TTJets_SemiLeptMGDecays_8TeV-madgraph_Summer12_DR53X-PU_S10_START53_V7A_ext-v1/V05-03-24/merged*root",cms2_skim_location.data()));
        ch_ttor->Add(Form("%s/Summer12_53X_MC/TTJets_HadronicMGDecays_8TeV-madgraph_Summer12_DR53X-PU_S10_START53_V7A_ext-v1/V05-03-24/merged*root",cms2_skim_location.data()));
      ...
      //cout << "Doing the Fall11 MC@NLO ttbar no-dileptons" << endl; ch_ttor->Add("/nfs-7/userdata/cms2/TT_TuneZ2_7TeV-mcatnlo_Fall11-PU_S6_START42_V14B-v1/V04-02-29_fix_dilepton/merged*root");
        ch_ttor->Add(Form("%s/Summer12_53X_MC/TTJets_SemiLeptMGDecays_8TeV-madgraph_Summer12_DR53X-PU_S10_START53_V7A_ext-v1/V05-03-24/merged*root",cms2_location.data()));
        ch_ttor->Add(Form("%s/Summer12_53X_MC/TTJets_HadronicMGDecays_8TeV-madgraph_Summer12_DR53X-PU_S10_START53_V7A_ext-v1/V05-03-24/merged*root",cms2_location.data()));
    }
    //for samples with no negative weights 
  ...
  if (runWjets) {
    ...
    if(runskim){
	  ...
	  //Missing skim:
	      //ch_wjets->Add(Form("%s/Summer12_53X_MC/WJetsToLNu_TuneZ2Star_8TeV-madgraph-tarball_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-24/merged*root",cms2_skim_location.data()));
	  //Full sample:
	  ch_wjets->Add("/hadoop/cms/store/group/snt/papers2012/Summer12_53X_MC/WJetsToLNu_TuneZ2Star_8TeV-madgraph-tarball_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-28/merged*.root");
    }
    else{
      ...
      //ch_wjets->Add(Form("%s/Summer12_53X_MC/WJetsToLNu_TuneZ2Star_8TeV-madgraph-tarball_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-24/merged*root",cms2_location.data()));
	  ch_wjets->Add("/hadoop/cms/store/group/snt/papers2012/Summer12_53X_MC/WJetsToLNu_TuneZ2Star_8TeV-madgraph-tarball_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-28/merged*.root");
    }
  ...
  if (runDYee) {
    ...
    if(runskim){
      ...
      //ch_dyee->Add(Form("%s/%s", cms2_skim_location.c_str(),"DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola_Summer11-PU_S4_START42_V11-v1/V04-02-29/skimmed*.root")); 
        ch_dyee->Add(Form("%s/Summer12_53X_MC/DYToEE_M_20_TuneZ2star_8TeV_pythia6_v2_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_skim_location.data()));
        ch_dyee->Add(Form("%s/Summer12_53X_MC/DYJetsToLL_M-50_TuneZ2Star_8TeV-madgraph-tarball_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_skim_location.data()));
    }
    else{
      ...
      //ch_dyee->Add("/nfs-7/userdata/cms2/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola_Summer11-PU_S4_START42_V11-v1/V04-02-29/merged*.root");
        ch_dyee->Add(Form("%s/Summer12_53X_MC/DYToEE_M_20_TuneZ2star_8TeV_pythia6_v2_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_location.data()));
        ch_dyee->Add(Form("%s/Summer12_53X_MC/DYJetsToLL_M-50_TuneZ2Star_8TeV-madgraph-tarball_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_location.data()));
    }
  ...
  if (runDYmm) {
    ...
    if(runskim){
      ...
      //ch_dymm->Add(Form("%s/%s", cms2_skim_location.c_str(),"DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola_Summer11-PU_S4_START42_V11-v1/V04-02-29/skimmed*.root")); 
        ch_dymm->Add(Form("%s/Summer12_53X_MC/DYToMuMu_M_20_TuneZ2star_8TeV_pythia6_v2_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_skim_location.data()));
        ch_dymm->Add(Form("%s/Summer12_53X_MC/DYJetsToLL_M-50_TuneZ2Star_8TeV-madgraph-tarball_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_skim_location.data())); 
    }
    else{
      ...
      //ch_dymm->Add("/nfs-7/userdata/cms2/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola_Summer11-PU_S4_START42_V11-v1/V04-02-29/merged*.root"); 
        ch_dymm->Add(Form("%s/Summer12_53X_MC/DYToMuMu_M_20_TuneZ2star_8TeV_pythia6_v2_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_location.data()));
        ch_dymm->Add(Form("%s/Summer12_53X_MC/DYJetsToLL_M-50_TuneZ2Star_8TeV-madgraph-tarball_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_location.data())); 
    }
  ...
  if (runDYtautau) {
    ...
    if(runskim){
      ...
      //ch_dytt->Add(Form("%s/%s", cms2_skim_location.c_str(),"DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola_Summer11-PU_S4_START42_V11-v1/V04-02-29/skimmed*.root"));
        ch_dytt->Add(Form("%s/Summer12_53X_MC/DYJetsToLL_M-50_TuneZ2Star_8TeV-madgraph-tarball_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_skim_location.data()));
    }
    else{
      ...
      //ch_dytt->Add("/nfs-7/userdata/cms2/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola_Summer11-PU_S4_START42_V11-v1/V04-02-29/merged*.root");
        ch_dytt->Add(Form("%s/Summer12_53X_MC/DYJetsToLL_M-50_TuneZ2Star_8TeV-madgraph-tarball_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_location.data()));
    }
  ...
  if(runVV) {
    ...
    if(runskim){
	  ...
	  */
        ch_vv->Add(Form("%s/Summer12_53X_MC/WZJetsTo2L2Q_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_skim_location.data()));
        ch_vv->Add(Form("%s/Summer12_53X_MC/WZJetsTo3LNu_TuneZ2_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_skim_location.data()));  
        ch_vv->Add(Form("%s/Summer12_53X_MC/WWJetsTo2L2Nu_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23//merged*root",cms2_skim_location.data())); 
        ch_vv->Add(Form("%s/Summer12_53X_MC/ZZJetsTo2L2Nu_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7A-v3/V05-03-23/merged*root",cms2_skim_location.data())); 
        ch_vv->Add(Form("%s/Summer12_53X_MC/ZZJetsTo2L2Q_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_skim_location.data())); 
        ch_vv->Add(Form("%s/Summer12_53X_MC/ZZJetsTo4L_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_skim_location.data())); 
      /*
	  ...
	  */
        ch_vv->Add(Form("%s/Summer12_53X_MC/WZJetsTo2L2Q_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_location.data())); 
        ch_vv->Add(Form("%s/Summer12_53X_MC/WZJetsTo3LNu_TuneZ2_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_location.data())); 
        ch_vv->Add(Form("%s/Summer12_53X_MC/WWJetsTo2L2Nu_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23//merged*root",cms2_location.data())); 
        ch_vv->Add(Form("%s/Summer12_53X_MC/ZZJetsTo2L2Nu_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7A-v3/V05-03-23/merged*root",cms2_location.data())); 
        ch_vv->Add(Form("%s/Summer12_53X_MC/ZZJetsTo2L2Q_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_location.data())); 
        ch_vv->Add(Form("%s/Summer12_53X_MC/ZZJetsTo4L_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_location.data())); 
     /*
  ...
  if(runtW) {
    ...
    if(runskim){
	  ...
	  */
        ch_tw->Add(Form("%s/Summer12_53X_MC/T_tW-channel-DR_TuneZ2star_8TeV-powheg-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_skim_location.data()));
        ch_tw->Add(Form("%s/Summer12_53X_MC/T_s-channel_TuneZ2star_8TeV-powheg-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23//merged*root",cms2_skim_location.data()));
        ch_tw->Add(Form("%s/Summer12_53X_MC/T_t-channel_TuneZ2star_8TeV-powheg-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_skim_location.data()));
        ch_tw->Add(Form("%s/Summer12_53X_MC/Tbar_tW-channel-DR_TuneZ2star_8TeV-powheg-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_skim_location.data()));
        ch_tw->Add(Form("%s/Summer12_53X_MC/Tbar_s-channel_TuneZ2star_8TeV-powheg-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_skim_location.data()));
        ch_tw->Add(Form("%s/Summer12_53X_MC/Tbar_t-channel_TuneZ2star_8TeV-powheg-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_skim_location.data()));
      /*
	  ...
	  */
        ch_tw->Add(Form("%s/Summer12_53X_MC/T_tW-channel-DR_TuneZ2star_8TeV-powheg-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_location.data()));
        ch_tw->Add(Form("%s/Summer12_53X_MC/T_s-channel_TuneZ2star_8TeV-powheg-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23//merged*root",cms2_location.data()));
        ch_tw->Add(Form("%s/Summer12_53X_MC/T_t-channel_TuneZ2star_8TeV-powheg-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_location.data()));
        ch_tw->Add(Form("%s/Summer12_53X_MC/Tbar_tW-channel-DR_TuneZ2star_8TeV-powheg-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_location.data()));
        ch_tw->Add(Form("%s/Summer12_53X_MC/Tbar_s-channel_TuneZ2star_8TeV-powheg-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_location.data()));
        ch_tw->Add(Form("%s/Summer12_53X_MC/Tbar_t-channel_TuneZ2star_8TeV-powheg-tauola_Summer12_DR53X-PU_S10_START53_V7A-v1/V05-03-23/merged*root",cms2_location.data()));
